...
Die Import-Export-Komponente wurde im Laufe der Implementierung stark angepasst. Anders als im Entwurf haben wir das Exportieren vom Importieren getrennt.
