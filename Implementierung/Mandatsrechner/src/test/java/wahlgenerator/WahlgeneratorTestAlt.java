...
/**
 * Testklasse für den Wahlgenerator.
 */
public class WahlgeneratorTestAlt {
	...
	public static void setUpBeforeClass() {
		...
		try {
			WahlgeneratorTestAlt.wahl2013 = iem.importieren(csvDateien);
		} catch (Exception e1) {
			e1.printStackTrace();
			System.out.println("Die zu importierenden csv Dateien sind ungültig!");
		}
