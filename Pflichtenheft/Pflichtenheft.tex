...
Da das aktuelle Wahlsystem sehr komplex ist, besteht eine weitere Aufgabe des Programms darin, das Zustandekommen von Direktmandaten \footnote{\textbf{Direktmandat} - Mandat eines Abgeordneten, der in einem Wahlkreis die einfache Mehrheit der Erststimmen erhalten hat}, Überhangmandaten \footnote{\textbf{Überhangmandat} - Überhangmandate entstehen, wenn eine Partei durch Direktmandate mehr Mandate besitzt, als ihr nach Zweitstimmen zustehen sollte}, Ausgleichsmandaten \footnote{\textbf{Ausgleichsmandat} - Zusatzmandate, die Parteien erhalten, um Überhangmandate einer Partei auszugleichen, damit andere Parteien, ohne Überhangmandate, nicht benachteiligt werden} usw. dem Anwender verständlich zu erklären.
Darunter fallen auch paradox erscheinende Vorkommnisse, wie das negative Stimmgewicht \footnote{\textbf{Negatives Stimmgewicht} - Das negative Stimmgewicht ist ein Effekt bei Wahlen, bei dem sich Wählerstimmen gegen den Wählerwillen auswirken. D.h. einer Partei werden, obwohl sie insgesamt an Stimmen gewinnt, Sitze abgezogen, bzw. für fehlende Stimmen Zusatzsitze gegeben}, die durch das Programm gefunden und erklärt werden sollen. \newline
...
\begin{itemize}
\item Berechnen der Mandate \footnote{\textbf{Mandat} - Der einem Abgeordneten von seinen Wählern erteilte Vertretungsauftrag im Bundestag} (Direkt-, Überhang- und Ausgleichsmandate) 
\item Berechnen der restlichen Sitzverteilung im Deutschen Bundestag anhand der Zweitstimmen \footnote{\textbf{Zweitstimme} - Mit der Zweitstimme wählt der Wähler eine Partei, deren Kandidaten auf der Landesliste zusammengestellt wurden. Sie legt also die Stärke und Zusammensetzung einer Partei im Parlament fest.}
\end{itemize} 
...
\begin{description}
	...
	Wurde eine Stimmzahl, ob in einem Wahlkreis \footnote{\textbf{Wahlkreis} - Der Wahlkreis ist die kleinste Einheit des Wahlgebietes, die für die Sitzverteilung relevant ist} oder in einem ganzen Bundesland, verändert, kann die Änderung bis zu fünf Mal widerrufen werden.
...
\newpage
\renewcommand{\notesname}{15 Glossar}
\addcontentsline{toc}{section}{15 Glossar}
