...
\begin{itemize}
	...
	\end{itemize}
	Es gibt hierbei verschiedene Ansichten.
	\begin{itemize}
		\item Bundesansicht
		\item Landesansicht
	\end{itemize}
	...
	Ein Zurück-Pfeil wechselt zur vorherigen Ansicht.
	\item /F10080/ Diagrammfenster \hfill \\
	Im Diagrammfenster sieht man Diagramme den Daten entsprechend und zur aktuellen Ansicht.
	\item /F10090/ Kartenfenster \hfill \\
	Die Länder werden nach einer Überprüfung (/F30010/), kartografisch im Fenster dargestellt. Der klick auf ein Bundesland öffnet die Bundeslandansicht. \\
