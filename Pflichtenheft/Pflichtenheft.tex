...
\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Wahldaten generieren /F30040/
		\end{itemize}
		\item Hilfe
		\begin{itemize}
...
\begin{itemize}
	...
	Überprüft, ob die eingegebenen Ländernamen mit den vorgegebenen Bundesländern übereinstimmen (/PD04/). Falls alle Ländernamen gefunden werden, wird die kartografische Darstellung (/F10090/) aktiviert.
	...
	Diese haben sofortigen Einfluss auf Karten- (/F10090/) und Diagrammfenster (/F10080/).
	...
	Nachdem die Wahlergebnisse (/PD02/) entweder geladen oder verändert wurden (/F30080/), werden sie ausgewertet, d.h. alle Bereiche werden angepasst.
	\item /F30080/ Verändern der Wahlergebnisse \hfill \\
	In dem Tabellenfenster (/F10070/) können Stimmzahlen einzelner Wahlkreise verändert werden.
