...
\subsection{Import}
\includegraphics[scale=0.5]{Import Sequenzdiagramm.png} \\

\subsection{Export}
\includegraphics[scale=0.5]{Export Sequenzdiagramm.png} \\

\subsection{Paradoxe Wahlgenerierung und Vergleich}
\includegraphics[scale=0.5]{paradoxeWahlgenerierung+Vergleich.png} \\

\subsection{Vergleich}
\includegraphics[scale=0.5]{Vergleich Sequenzdiagramm.png} \\
