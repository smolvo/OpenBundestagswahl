...
Wird von der {\myma{Steuerung}} aufgerufen und gibt die zuletzt hinzugefügte {\myma{Stimme}} zurück.
\end{description}
...
\subsection{Meldung}
Die Klasse {\myma{Meldung}} ist verantwortlich für Fehlermeldungen, Benachrichtigungen und Fenstertexte. Es 
