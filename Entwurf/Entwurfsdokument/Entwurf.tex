...
Das VergleichsFenster ist ein Teil des ProgrammFensters, wenn zwei verschiedene Wahlen verglichen werden.\\
	Methode :
	\begin{description}
...
Das WahlFenster repräsentiert eine einzelne Bundestagswahl. In einem ProgrammFenster sind mehrere WahlFenster möglich, die in Form von Tabs dargestellt werden.\\
Methoden :
	\begin{description}
...
Das TabellenFenster korrespondiert zu dem im Pflichtenheft beschriebenen Tabellenfenster. Es stellt Teile der Bundestagswahl-Klasse dar. \\
	Methoden :
	\begin{description}
...
Das KartenFenster korrespondiert zu dem im Pflichtenheft beschriebenen Kartenfenster. Hier wird eine Liste der Bundesländer und Wahlkreise und, wenn möglich, eine kartografische Darstellung Deutschlands durch ein Bundestagswahl-Objekt dargestellt. \\
	Methode :
	\begin{description}
...
Die GUISteuerung sorgt dafür, dass die aktuellste Version der Bundestagswahl in einem WahlFenster visualisiert wird. Dafür bekommt sie das aktuellste Bundestagswahl-Objekt der Steuerung und verteilt die Darstellungsarbeit an die Komponenten des WahlFensters.
	Methode :
	\begin{description}
