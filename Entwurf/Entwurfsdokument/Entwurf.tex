...
Das {\myma{VergleichsFenster}} ist ein Teil des ProgrammFensters, wenn zwei verschiedene {\myma{Bundestagswahl}}en verglichen werden.\\
	\begin{description}
...
Folgende Methoden sind enthalten:
          \begin{description}
              ...
              Eine BeDiese Funktion sucht alle Stimmen nach den selben Assoziationen und ruft 
